      ...
      <ModalContent>
        ...
        <ModalBody>
          <VStack align="start" spacing={4}>
            <Category
              heading={<FormattedMessage defaultMessage="Server clock" />}
            >
              ...
              <KeyHint>
                <FormattedMessage
                  ...
                  values={{
                    values: (
                      <>
                        20 <Kbd>2</Kbd>, 30 <Kbd>3</Kbd>, 40 <Kbd>4</Kbd>, 60{" "}
                        <Kbd>6</Kbd>
                      </>
                    ),
                  }}
              ...
              <KeyHint>
                <FormattedMessage
                  ...
                  values={{
                    values: (
                      <>
                        20 <Kbd>shift+2</Kbd>, 30 <Kbd>shift+3</Kbd>, 40{" "}
                        <Kbd>shift+4</Kbd>, 60 <Kbd>shift+6</Kbd>
                      </>
                    ),
                  }}
                />
            ...
            <Category
              heading={<FormattedMessage defaultMessage="Task scheduler" />}
            >
              <KeyHint shortcut="f">
              ...
              <KeyHint
                shortcut={`${formatMessage({ defaultMessage: "shift" })}+n`}
              >
