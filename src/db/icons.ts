...
function addIcons(
  type: string,
  items: { name: string; timer?: Task["refreshTime"] }[]
) {
  for (const { name, timer } of items) {
    ...
    timer &&
      (KnownResourceTimers[name] =
        typeof timer === "number" ? timer * 3600000 : timer);
  }
}

addIcons(registerMessage({ defaultMessage: "Gadget" }), [
  {
    name: registerMessage({ defaultMessage: "Portable Waypoint" }),
    timer: 168,
  },
  {
    name: registerMessage({ defaultMessage: "Adepti Seeker's Stove" }),
    timer: 5 / 60,
  },
  {
    name: registerMessage({ defaultMessage: "Parametric Transformer" }),
    timer: 168,
  },
...
addIcons(registerMessage({ defaultMessage: "Ore" }), [
  ...
  {
    name: registerMessage({ defaultMessage: "Magical Crystal Chunk" }),
    timer: "reset",
  },
...
addIcons(registerMessage({ defaultMessage: "Common ascension material" }), [
  {
    name: registerMessage({ defaultMessage: "Slime Condensate" }),
    timer: "reset",
  },
  { name: registerMessage({ defaultMessage: "Damaged Mask" }), timer: "reset" },
  {
    name: registerMessage({ defaultMessage: "Firm Arrowhead" }),
    timer: "reset",
  },
  {
    name: registerMessage({ defaultMessage: "Divining Scroll" }),
    timer: "reset",
  },
  { name: registerMessage({ defaultMessage: "Heavy Horn" }), timer: "reset" },
  {
    name: registerMessage({ defaultMessage: "Dead Ley Line Branch" }),
    timer: "reset",
  },
  { name: registerMessage({ defaultMessage: "Chaos Device" }), timer: "reset" },
  {
    name: registerMessage({ defaultMessage: "Mist Grass Pollen" }),
    timer: "reset",
  },
  {
    name: registerMessage({ defaultMessage: "Hunter's Sacrificial Knife" }),
    timer: "reset",
  },
  {
    name: registerMessage({ defaultMessage: "Recruit's Insignia" }),
    timer: "reset",
  },
  {
  ...
  {
    name: registerMessage({ defaultMessage: "Fragile Bone Shard" }),
    timer: "reset",
  },
  {
  ...
  {
    name: registerMessage({ defaultMessage: "Spectral Husk" }),
    timer: "reset",
  },
  {
...
addIcons(registerMessage({ defaultMessage: "Furnishing" }), [
  ...
  {
    name: registerMessage({ defaultMessage: "Bamboo Segment" }),
    timer: "reset",
  },
  { name: registerMessage({ defaultMessage: "Birch Wood" }), timer: "reset" },
  {
    name: registerMessage({ defaultMessage: "Fragrant Cedar Wood" }),
    timer: "reset",
  },
  ...
  {
    name: registerMessage({ defaultMessage: "Sandbearer Wood" }),
    timer: "reset",
  },
]);
...
addIcons(registerMessage({ defaultMessage: "Material" }), [
  ...
  {
    name: registerMessage({ defaultMessage: "Flaming Flower Stamen" }),
    timer: 24,
  },
  ...
  {
    name: registerMessage({ defaultMessage: "Mist Flower Corolla" }),
    timer: 24,
  },
  {
    name: registerMessage({ defaultMessage: "Vitalized Dragontooth" }),
    timer: 48,
  },
]);
