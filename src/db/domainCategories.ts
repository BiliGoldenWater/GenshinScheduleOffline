...
export const DomainOfMastery: DomainCategory = {
  ...
  dropDescription: registerMessage({
    defaultMessage: "Talent Level-Up Materials",
  }),
...
export const DomainOfForgery: DomainCategory = {
  ...
  dropDescription: registerMessage({
    defaultMessage: "Weapon Ascension Materials",
  }),
...
export const NormalBoss: DomainCategory = {
  ...
  dropDescription: registerMessage({
    defaultMessage: "Character Ascension Materials and Artifacts",
  }),
  domains: [
    AnemoHypostasis,
    MaguuKenki,
